...
class Ludo:
    def __init__(self, root,six_side_block,five_side_block,four_side_block,three_side_block,two_side_block,one_side_block):
        self.window = root
        self.make_canvas = Canvas(self.window, bg="#4d4dff", width=600, height=530)
...
if __name__ == '__main__':
    ...
    window.title("Let's play ludo")
    window.iconbitmap("Images/ludo_icon.ico")
    block_six_side = ImageTk.PhotoImage(Image.open("Images/6_block.png").resize((32, 32), Image.ANTIALIAS))
